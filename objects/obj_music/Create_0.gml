...
addRoomMusic(hub_paintstudio, mu_hub, undefined, undefined)
addRoomMusic(hub_soundTest, undefined, undefined, undefined)
addRoomMusic(hub_demohallway, mu_hub, undefined, undefined)
addRoomMusic(hub_mindpalace, mu_painterBrain, undefined, undefined)
addRoomMusic(hub_mindvault, mu_harry, undefined, undefined)
addRoomMusic(hub_molasses, mu_hub, undefined, undefined)
addRoomMusic(internship_floor1, mu_hub, undefined, undefined)
addRoomMusic(internship_floor1, mu_hub, undefined, undefined)
addRoomMusic(tower_1, mu_hub, undefined, undefined)
addRoomMusic(tower_2, mu_hub, undefined, undefined)
addRoomMusic(tower_3, mu_hub, undefined, undefined)
addRoomMusic(tower_4, mu_hub, undefined, undefined)
addRoomMusic(tower_5, mu_hub, undefined, undefined)
addRoomMusic(tower_entrancehall, mu_hub, undefined, undefined)
addRoomMusic(tower_johngutterhall, mu_hub, undefined, undefined)
