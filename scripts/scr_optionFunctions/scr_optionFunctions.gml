...
function init_option()
{
	...
	global.laphell = ini_read_real("Settings", "laphell", 0)
	global.fps = ini_read_real("Settings", "fps", 0)
	global.skipintro = ini_read_real("Settings", "skipintro", 0)
	global.virtualcontroller = ini_read_real("Settings", "virtualcontroller", (os_type == os_windows ? 0 : 1))
	global.enmode = ini_read_real("Settings", "enmode", 1)
	global.cowboyhat = ini_read_real("Settings", "cowboyhat", 0)
	/*
	global.lap3 = ini_read_real("Settings", "lap3", 0)
	global.lap3 = ini_read_real("Settings", "lap3", 0)
	global.lap3 = ini_read_real("Settings", "lap3", 0)
	global.lap3 = ini_read_real("Settings", "lap3", 0)
	global.lap3 = ini_read_real("Settings", "lap3", 0)
