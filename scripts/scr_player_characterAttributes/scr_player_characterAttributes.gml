...
{
	var character_prefix = ["PZ", "PN", "GB", "C", "PP", "N", "V", "MOD"]
...
function scr_characterSprite()
{
	...
	spr_move_breakdance = scr_getCharacterSprite(spr_player_PZ_walk_breakdance)
	spr_move_dance = scr_getCharacterSprite(spr_player_PZ_walk_dance)
...
function scr_characterTVSprite()
{
	...
	global.TvSprPlayer_HurtExp = 
	[
		scr_getCharacterTVSprite(spr_tvHUD_player_PZ_hurtExp_1), 
		scr_getCharacterTVSprite(spr_tvHUD_player_PZ_hurtExp_2), 
		scr_getCharacterTVSprite(spr_tvHUD_player_PZ_hurtExp_3), 
		scr_getCharacterTVSprite(spr_tvHUD_player_PZ_hurtExp_4), 
		scr_getCharacterTVSprite(spr_tvHUD_player_PZ_hurtExp_5), 
		scr_getCharacterTVSprite(spr_tvHUD_player_PZ_hurtExp_6), 
		scr_getCharacterTVSprite(spr_tvHUD_player_PZ_hurtExp_7), 
		scr_getCharacterTVSprite(spr_tvHUD_player_PZ_hurtExp_8), 
		scr_getCharacterTVSprite(spr_tvHUD_player_PZ_hurtExp_9), 
		scr_getCharacterTVSprite(spr_tvHUD_player_PZ_hurtExp_10)
	]
...
define_player_palette(Characters.Pizzelle, "palette_PZ_classic", #ffffff, #88a8c8, #88a8c8);
...
define_player_palette(Characters.Pizzelle, "palette_PZ_exhibitionnight", #d0b8b8, #af6669, #602828);
...
define_player_palette(Characters.Pizzelle, "palette_PZ_exhibitionred", #e03000, #580000, #580000);
...
define_player_palette(Characters.Pizzelle, "palette_PZ_exhibitionblack", #3e3e49, #182028, #182028);
...
define_player_palette(Characters.Pizzelle, "palette_PZ_exhibitionpurple", #6f5bab, #3d2d6e, #3d2d6e, undefined, #c80090, #900040, #d0b8b8);
...
define_player_palette(Characters.Pizzelle, "palette_PZ_noise", #f8e080, #d88818, #d88818, undefined, #d88818, #a03800, #a03800);
...
define_player_palette(Characters.Pizzelle, "palette_PZ_exhibitionbrain", undefined, c_black, #741A45, spr_demopattern_brain, #a82860, #780038, #780038);
define_player_palette(Characters.Pizzelle, "palette_PZ_exhibitionbraingold", undefined, c_black, #580000, spr_demopattern_brainGold, #943000, #502620, #502620);
define_player_palette(Characters.Pizzelle, "palette_PZ_exhibitionpaper", undefined, c_black, #78A8F8, spr_demopattern_paper, #90b0f8, #1070d0, #1070d0);
define_player_palette(Characters.Pizzelle, "palette_PZ_exhibitionentryway", undefined, c_black, #E09000, spr_demopattern_entryway, #b83830, #602828, #602828);
define_player_palette(Characters.Pizzelle, "palette_PZ_exhibitionsteamy", undefined, c_black, #FFDEF9, spr_demopattern_steamy, #a880a8, #8038f0, #686090);
define_player_palette(Characters.Pizzelle, "palette_PZ_exhibitionmineshaft", undefined, c_black, #09447F, spr_demopattern_mineshaft, #60d048, #006858, #006858);
define_player_palette(Characters.Pizzelle, "palette_PZ_exhibitionmolasses", undefined, c_black, #006858, spr_demopattern_molasses, #f87018, #b03000, #b03000);
