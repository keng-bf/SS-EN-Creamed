...
{
	if global.playerCharacter = Characters.Custom{
	spr_idle = sprite_add_gif("character/test/spr_idle.gif", 50, 50)
	spr_idle_tired = sprite_add_gif("character/test/spr_tired.gif", 50, 50)
	spr_idle_breakdance = sprite_add_gif("character/test/spr_idle_breakdance.gif", 50, 50)
	spr_idle_dance = sprite_add_gif("character/test/spr_idle_dance.gif", 50, 50)
	spr_move = sprite_add_gif("character/test/spr_walk.gif", 50, 50)
	spr_move_breakdance = sprite_add_gif("character/test/spr_walk_breakdance.gif", 50, 50)
	spr_move_dance = sprite_add_gif("character/test/spr_walk_dance.gif", 50, 50)
	spr_smallComboIdle = sprite_add_gif("character/test/spr_idle_comboSmall.gif", 50, 50)
...
define_palette_sprite(Characters.Custom, [0, 1])
...
define_player_palette(Characters.Custom, "palette_PZ_default", 4259839, 3979494, 2631776, undefined, 13773959, 3736096, 9988216, 8628991, 14496)
...
define_player_palette(Characters.Custom, "palette_PZ_classic", 16777215, 13150344, 13150344, undefined)
