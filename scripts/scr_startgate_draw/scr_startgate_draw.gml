...
{
	var w = sprite_get_width(sprite_index),h = sprite_get_height(sprite_index),x_offset = sprite_get_xoffset(sprite_index),y_offset = sprite_get_yoffset(sprite_index),i,_layer,my_height
...
{
	var w = sprite_get_width(sprite_index),h = sprite_get_height(sprite_index),u_resolution = shader_get_uniform(shd_noise, "u_resolution"),u_offset = shader_get_uniform(shd_noise, "u_offset"),u_intensity = shader_get_uniform(shd_noise, "u_intensity"),arrLast = array_length(details) - 1
