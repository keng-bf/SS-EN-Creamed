...
{
	var dont_pause = [obj_pause, obj_fmod, obj_music, obj_screen, obj_rpc, obj_localizer, obj_gametimer, obj_inputController, obj_fps, obj_virtual_controller, obj_virtual_controller_manager]
